...
function updatecart(cloth) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', cloth).then(function (res) {
    // console.log(res)
...
addTocart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    // console.log(e);
    var cloth = JSON.parse(btn.dataset.cloth);
    updatecart(cloth); // console.log(cloth)
  });
...
var order = hiddenInput ? hiddenInput : null;
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataPop = status.dataset.status;
...
paymentForm.addEventListener('submit', function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/orders', formObject.then(function () {})); // console.log(formData)
}); //Socket
// let socket = io()
// initAdmin(socket)
// //join
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkproject_1"] = self["webpackChunkproject_1"] || [];
